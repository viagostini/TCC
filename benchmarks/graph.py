...
"""for n in M:
    arr = []
    with open(str(root)+ 'naive_linear_' + str(n) + '_query.txt') as f:
        for line in f:
...
for n in M:
    arr = []
    with open(str(root)+ 'preorder_linear_' + str(n) + '_query.txt') as f:
        for line in f:
            arr.append(float(line))
...
for n in M:
    arr = []
    with open(str(root)+ 'table_linear_' + str(n) + '_query.txt') as f:
        for line in f:
            arr.append(float(line))
...
for n in M:
    arr = []
    with open(str(root)+ 'jump_linear_' + str(n) + '_query.txt') as f:
        for line in f:
            arr.append(float(line))
...
plt.savefig("../modelo-latex/figuras/query_linear_smaller.pdf")
#plt.show()
